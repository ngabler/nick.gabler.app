document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function resizeCanvas() {
        ...
        newMouseX = mouseX;
        newMouseY = mouseY;
        populateStars(); // Recalculate and repopulate stars
    }
    ...
    class Star extends StaticStar {
        ...
        updatePosition() {
            const dx = newMouseX - this.initialMouseX;
            const dy = newMouseY - this.initialMouseY;
            this.x += dx * this.speed;
            this.y += dy * this.speed;
            this.initialMouseX = newMouseX;
            this.initialMouseY = newMouseY;
    ...
    resizeCanvas(); // This will also call populateStars initially
